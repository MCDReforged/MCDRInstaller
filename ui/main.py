...
class SetFrame ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"MCDR Installer", pos = wx.DefaultPosition, size = wx.Size( 475,270 ), style = wx.DEFAULT_FRAME_STYLE )
        ...
        self.path_text = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_READONLY )
...
class InstallFrame ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"MCDR Installer", pos = wx.DefaultPosition, size = wx.Size( 465,224 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
        ...
        self.progress_text.SetFont( wx.Font( 12, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "微软雅黑" ) )
        ...
        self.subprogress = wx.Gauge( self, wx.ID_ANY, 100, wx.DefaultPosition, wx.Size( self.Size[0], 10 ), wx.GA_HORIZONTAL )
...
class LinkDialog ( wx.Dialog ):
    ...
    def __init__( self, parent, title='',  message='' ):
        wx.Dialog.__init__ ( self, parent, title=title, pos = wx.DefaultPosition, size = wx.Size( 600,350 ), style = wx.DEFAULT_DIALOG_STYLE )

        self.SetSizeHints( wx.DefaultSize, wx.DefaultSize )

        bSizer8 = wx.BoxSizer( wx.VERTICAL )

        self.m_textCtrl2 = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.HSCROLL|wx.TE_AUTO_URL|wx.TE_MULTILINE|wx.TE_READONLY|wx.TE_RICH2 )
        self.m_textCtrl2.SetValue(message)
        self.m_textCtrl2.Bind(wx.EVT_TEXT_URL, self.open_url)
        self.m_textCtrl2.SetFont( wx.Font( 10, wx.FONTFAMILY_MODERN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Consolas" ) )
